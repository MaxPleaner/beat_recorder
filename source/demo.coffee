window.BeatRecorderDemo = ->
  ...
  this.ExampleTicks =
    part1: [
      [HiHat].concat(ManyKicksAtOnce), [Kick], [Kick], [Kick],
      [Kick], [], [Kick], [],
      [HiHat].concat(ManyKicksAtOnce), [], [Kick], [],
      [Kick], [], [Kick], [],
      [HiHat, Snare], [], [Kick], [],
      [].concat(ManyKicksAtOnce), [], [Kick], [],
      [HiHat, Kick], [], [Kick], [],
      [Kick], [], [Kick], []
    ],
    part2: [
      ...
      [Kick], [], [Kick], [],
      [HiHat, Snare], [], [Kick], [],
      [ManyKicksAtOnce], [], [Snare, Kick], [],
      [HiHat].concat(ManyKicksAtOnce), [Kick], [Kick], [Kick],
      [Snare, Kick], [], [Kick], [],
    ]
    
  this.BeatRecorder
      .AddTickInterval(this.ExampleTicks['part1'].concat(this.ExampleTicks['part2']))
      .TickInterval.Start()